...
random (Fig.~\ref{}). The parameters for the EVD was estimated using the
method of moments.
...
(Fig.~\ref{}). The fragments lengths for all the comparisons were kept
constant at 40 bp, and the parameters for the normal distribution was
determined using the method of moments estimator.
...
(Fig.~\ref{}). For each $k$, the fragment lengths were generated from at
random from a geometric distribution.
