...
%
This is usually done by finding exact matches \citep{}, non-contiguous
exact matches \citep{}, or matches with a specified number of mismatches
\citep{} between the read and the reference genome.
%
...
Although both seeding and determing the accurate fragmentation is
crutial to align a SMURF-seq read, in this study we focus only on the
...
% Figure showing the p-value for 100 reads, and subfigure with the
% accuracy
...
% Figure showing p-value for a 1000 reads

% Figure showing accuracy for seveal fragment lengts and error rates
