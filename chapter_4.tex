%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%                                                              %%%%%
%%%%% Chapter 4: Identifying fragment boundaries                   %%%%%
%%%%%                                                              %%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
We used BWA-MEM \citep{li2013aligning} to align SMURF-seq reads
...
Erdos and Renyi presented results for the length of the longest headrun
...
%% m-dependence Here, we have a dependence between $X_j$ and $X_k$ for
%$|j - k| < m$.
...
\begin{algorithmic}[1]
  ...
  \FOR {$k \leftarrow 1$ \TO $m-1$}
    ...
    \IF {$k_{\mathrm{pval}} < pval_\mathrm{opt}$}
...
% in local alignment
In the context of local alignment, the theoretical
...
% random model
The random model used to determine the null distribution would have a
