...
approaches in strand sequencing used a DNA polymerase and recorded the
current levels as the DNA translocates through a pore with the
incorporation of each nucleotide
\citep{cockroft2008single,manrao2012reading}.
%
Subsequent approaches used xxx protein to control to rate of
translocation of a DNA molecule though a nanopore \citep{}.
