...
\citep{euskirchen2017same}. A typical Oxford MinION sequencing run
generates approximately 500k reads (length $\sim$8 kb)
\citep{jain2018nanopore,tyson2018minion}.  Read-counting applications in
...
\citep{muthukumar2010theory,wanunu2008dna}. We verified this rationale by
...
More specifically, genomic DNA is fragmented using restriction enzymes
...
% parameter options
These mapping tools have several parameter options, in general, these
